<div class="col-span-1 flex flex-col py-4 px-6 items-center border border-gray-200 bg-white rounded-lg shadow-lg">
    ...
    <div class="text-center mx-2 px-1 border-t border-gray-300 lg:text-start">
        ...
        <p class="mt-3 mb-3">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
        <p class="font-semibold">Author: <span class="font-normal ml-2">Fyodor Dostoevsky</span></p>
        <p class="font-semibold my-1">Price: <span class="font-normal ml-2">$20</span></p>
        <a href="#" class="font-semibold hover:text-violet-500">View More ></a>
    </div>
</div>
